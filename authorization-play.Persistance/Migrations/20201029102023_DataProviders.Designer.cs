...
namespace authorization_play.Persistance.Migrations
{
    ...
    [Migration("20201029102023_DataProviders")]
    partial class DataProviders
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("authorization_play.Persistance.Models.PrincipalRelation", b =>
                {
                    b.Property<int>("PrimaryPrincipalId")
                        .HasColumnType("integer");

                    b.Property<int>("SecondaryPrincipalId")
                        .HasColumnType("integer");

                    b.HasKey("PrimaryPrincipalId", "SecondaryPrincipalId");

                    b.HasIndex("SecondaryPrincipalId");
            ...
            modelBuilder.Entity("authorization_play.Persistance.Models.PrincipalRelation", b =>
                {
                    b.HasOne("authorization_play.Persistance.Models.Principal", "Primary")
                        .WithMany("PrimaryRelations")
                        .HasForeignKey("PrimaryPrincipalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("authorization_play.Persistance.Models.Principal", "Secondary")
                        .WithMany("SecondaryRelations")
                        .HasForeignKey("SecondaryPrincipalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
